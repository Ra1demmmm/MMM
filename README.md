...
This repo contains source codes for the paper [**MMM: A Unified Weakly-supervised Anomaly Detection Framework for Multi-distributional Data**](https://) published on IEEE Transactions on Knowledge and Data Engineering.
